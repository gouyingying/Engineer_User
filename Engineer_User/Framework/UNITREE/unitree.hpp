...
#define SET_485_DE_UP() HAL_GPIO_WritePin(GPIOB, DE_485_Pin, GPIO_PIN_SET)
#define SET_485_DE_DOWN() HAL_GPIO_WritePin(GPIOB, DE_485_Pin, GPIO_PIN_RESET)

#define SET_485_RE_UP() HAL_GPIO_WritePin(GPIOB, RE_485_Pin, GPIO_PIN_SET)
#define SET_485_RE_DOWN() HAL_GPIO_WritePin(GPIOB, RE_485_Pin, GPIO_PIN_RESET)
