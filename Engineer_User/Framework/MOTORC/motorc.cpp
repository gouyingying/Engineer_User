...
Class_Motor_C620 pitch_3508;
Class_Motor_C620 roll_3508;

Class_Motor_C620 roll_3508_1;

Class_Motor_C610 roll_2006;


Class_Motor_C610 image_ptich;
/**
 * @brief 分配CAN发送缓冲区
 *
 * @param hcan CAN编号
...
//    usart_printf("%.2f,%.2f,%.2f,%.2f\r\n",Now_Angle,Now_Omega,Now_Torque,Now_Temperature);
}
...
void Class_Motor_GM6020::TIM_PID_PeriodElapsedCallback()
{
    switch (Control_Method)
    {
        ...
        {
//            usart_printf("7654321 \r\n");
            PID_Omega.Set_Target(Target_Omega);
            PID_Omega.Set_Now(Now_Omega);
            PID_Omega.TIM_Adjust_PeriodElapsedCallback();//pid计算
...
float Class_Motor_C620::Get_ROUND()
{
    return (Total_Round);
}
/**
...
float Class_Motor_C610::Get_ROUND()
{
    return (Total_Round);
}
