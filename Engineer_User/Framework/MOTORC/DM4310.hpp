...
protected:
    ...
    Enum_Motor_DM_Status motor_state_ = Motor_DM_Status_DISABLE;
...
extern Class_Motor_DM_Normal DM_yaw;
extern Class_Motor_DM_Normal DM_4310_pitch;
