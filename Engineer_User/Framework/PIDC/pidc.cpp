 ...
 * @param __D_T 时间片长度
 */
void pid::Init(float __K_P, float __K_I, float __K_D, float __K_F, float __I_Out_Max, float __Out_Max, float __D_T, float __Dead_Zone, float __I_Variable_Speed_A, float __I_Variable_Speed_B, float __I_Separate_Threshold, Enum_PID_D_First __D_First)
{
    K_P = __K_P;
    K_I = __K_I;
    K_D = __K_D;
 ...
 */
void pid::Set_I_Out_Max(float __I_Out_Max)
{
    I_Out_Max = __I_Out_Max;
}
 ...
 */
void pid::Set_Out_Max(float __Out_Max)
{
    Out_Max = __Out_Max;
}
 ...
 */
void pid::Set_I_Variable_Speed_A(float __I_Variable_Speed_A)
{
    I_Variable_Speed_A = __I_Variable_Speed_A;
}
 ...
 */
void pid::Set_I_Variable_Speed_B(float __I_Variable_Speed_B)
{
    I_Variable_Speed_B = __I_Variable_Speed_B;
}
 ...
 */
void pid::Set_I_Separate_Threshold(float __I_Separate_Threshold)
{
    I_Separate_Threshold = __I_Separate_Threshold;
}
 ...
 */
void pid::Set_Integral_Error(float __Integral_Error)
{
 ...
 * @return float 输出值
 */
void pid::TIM_Adjust_PeriodElapsedCallback()
{
    // P输出
    float p_out = 0.0f;
    // I输出
